...
export class GitWrapper {
  ...
  public async init(): Promise<void> {
    try {
      ...
      await FileSystem.mkdir(this.workingDir);
      ...
      throw new GitOperationError('init', { error: error.message, workingDir: this.workingDir });
    }
  }
  ...
  public async status(): Promise<any> {
    try {
      ...
      throw new GitOperationError('status', { error: error.message, workingDir: this.workingDir });
    }
  }
